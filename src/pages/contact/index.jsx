    ...
    <>
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-6 sm:px-10 lg:px-16 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-light mb-6 leading-tight tracking-wide animate-fade-in">
            Contact <span className="font-semibold italic text-amber-300">Us</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="lg:w-1/2 space-y-8">
              {[
                { icon: MapPin, title: "Address", content: "Nepal Cancer Hospital, Harisiddhi, Lalitpur, Nepal" },
                { icon: Phone, title: "Phone", content: "+977 1 1234567" },
                { icon: Mail, title: "Email", content: "contact@lovennature.com" },
                { icon: Clock, title: "Hours", content: "Mon-Fri: 9am-5pm, Sat: 10am-4pm" }
              ].map((item, idx) => (
                <div key={idx} className="flex items-start bg-white/80 backdrop-blur-sm rounded-2xl shadow-md p-5 transition-transform hover:-translate-y-1">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-5 shadow-md flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-bold text-xl text-slate-800">25°C</span>
                  </div>
      ...
      <div className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 text-center">
          <h2 className="text-3xl font-serif font-bold text-slate-800 mb-4">Find Us Here</h2>
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg h-96">
            <MapContainer center={position} zoom={15} style={{ height: '100%', width: '100%' }}>
              ...
              <Marker position={position}>
                <Popup>
                  <strong>Nepal Cancer Hospital</strong><br />Harisiddhi<br />Lalitpur, Nepal
                </Popup>
              </Marker>
            </MapContainer>
          </div>
